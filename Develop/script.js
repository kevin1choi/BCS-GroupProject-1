...
$(document).ready(function () {
  ...
  var queryURL = ["https://api.instagram.com/oembed?url=https://www.instagram.com/p/B_3ukUTnvST/", "https://api.instagram.com/oembed?url=https://www.instagram.com/p/B_1BdZgn0jv/", "https://api.instagram.com/oembed?url=https://www.instagram.com/p/B_gjv_gHt52/"];
  ...
  //     console.log(response.html)
  //     var imgURL = response.html;
  //     instagramDiv[i].html(imgURL);
  //     // for (i = 0; i < instagramDiv.length; i++) {
  //     //   var instagramDiv[i].html(imgURL);
  //     // };
  //     window.instgrm.Embeds.process();
  //   });
  // }
...
//   var queryURL = "https://api.instagram.com/oembed?url=https://www.instagram.com/p/B_3ukUTnvST/"
//    $.ajax({
//          url: queryURL,
//          method: "GET",
//      }).then(function(response){
...
//          var instagramOne = $("#instagramone");
//          instagramOne.html(imgUrl);
//          // replace with appropriate selectors from index.html
//          // var testOne = $("");
//          // testOne.html(imgUrl);             
//      })
//    var queryTwo = "https://api.instagram.com/oembed?url=https://www.instagram.com/p/B_1BdZgn0jv/"
//    $.ajax({
//        url: queryTwo,
//        method: "GET",
...
//        var imgUrlTwo = result.html;
//        var testTwo = $("#instagramtwo");
//        testTwo.html(imgUrlTwo);
//    })
//    var queryThree = "https://api.instagram.com/oembed?url=https://www.instagram.com/p/B_gjv_gHt52/"
//    $.ajax({
//        url: queryThree,
//        method: "GET",
//    }).then(function(outcome){
//        console.log(outcome);
//        console.log(outcome.html);
//        var imgUrlThree = outcome.html;

//        var testThree = $("#instagramthree");
//        testThree.html(imgUrlThree);
